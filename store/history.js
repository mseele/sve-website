export const state = () => ({
  nodes: [
    ...
    },
    {
      ...
      images: [
        {
          src: require('~/assets/history/maenner-2016-1.jpg'),
          lazy: require('~/assets/history/maenner-2016-1-min.jpg?inline')
        }
      ]
    },
    {
    ...
    },
    {
      ...
      images: [
        {
          src: require('~/assets/history/frauen-2016-1.jpg'),
          lazy: require('~/assets/history/frauen-2016-1-min.jpg?inline')
        },
        {
          src: require('~/assets/history/frauen-2016-2.jpg'),
          lazy: require('~/assets/history/frauen-2016-2-min.jpg?inline')
        },
        {
          src: require('~/assets/history/frauen-2016-3.jpg'),
          lazy: require('~/assets/history/frauen-2016-3-min.jpg?inline')
        }
      ]
    },
    {
      date: '17. Mai 2016',
      text:
        'Das Projekt Kunstrasen mit Sportheimneubau beginnt.<br/><br/>Das größte Projekt in der Vereinsgeschichte des SVE beginnt, nach mehrjähriger Planung, mit dem Spatenstich. Das Projekt ist ein Projekt für die kommenden Generationen.',
      images: [
        {
          src: require('~/assets/history/2016-1.jpg'),
          lazy: require('~/assets/history/2016-1-min.jpg?inline')
        }
      ]
    },
    {
    ...
    },
    {
      ...
      images: [
        {
          src: require('~/assets/history/2011-1.jpg'),
          lazy: require('~/assets/history/2011-1-min.jpg?inline')
        },
        {
          src: require('~/assets/history/2011-2.jpg'),
          lazy: require('~/assets/history/2011-2-min.jpg?inline')
        },
        {
          src: require('~/assets/history/2011-3.jpg'),
          lazy: require('~/assets/history/2011-3-min.jpg?inline')
        }
      ]
    },
    {
    ...
    },
    {
      ...
      images: [
        {
          src: require('~/assets/history/2009-1.jpg'),
          lazy: require('~/assets/history/2009-1-min.jpg?inline')
        },
        {
          src: require('~/assets/history/2009-2.jpg'),
    ...
    },
    {
      ...
      text:
        '„<i>Die Bekanntgabe der Generalversammlung wurde durch die Tageszeitung, sowie durch Ausschellen durch den Gemeindediener durchgeführt.</i>“'
    },
    {
      date: '31. Januar 1959',
      text:
    ...
    },
    {
      date: '14. Juni 1958',
      text:
        'Bei der Nachfeier zum Fest gab es für alle Helfer „<i>2 rote Würste, dazu wurde ein Fass Freibier, gestiftet von der Gambrinus-Brauerei in Nagold, getrunken.</i>“'
    },
    {
      date: '1. Juni 1958',
      text:
        'Sportfest mit Pokalturnier auf dem Eutinger Sportgelände. Stark die Beteiligung beim Fest durch die Schule, die Schüler führten einen Dreikampf im Weitsprung, Ballweitwurf und 50-m-Lauf durch. Rose Saur wurde Gesamtsieger. Die Leitung der Schülerwettbewerbe oblag Oberlehrer Wolfram Bihlmaier und der Lehrerlegende Lena Straub.<br/><br/>Eine Art Vorläufer des heutigen Gäupokals war das Pokalturnier mit den B-Klassen. Mannschaften aus Bondorf, Unterjettingen, Öschelbronn, Vollmaringen und Weitingen. Pokalsieger wurde der SV Unterjettingen.',
      images: [
        {
          src: require('~/assets/history/1958-1.jpg'),
          lazy: require('~/assets/history/1958-1-min.jpg?inline')
        },
        {
          src: require('~/assets/history/1958-2.jpg'),
          lazy: require('~/assets/history/1958-2-min.jpg?inline')
        },
        {
          src: require('~/assets/history/1958-3.jpg'),
          lazy: require('~/assets/history/1958-3-min.jpg?inline')
        },
        {
          src: require('~/assets/history/1958-4.jpg'),
          lazy: require('~/assets/history/1958-4-min.jpg?inline')
        },
        {
          src: require('~/assets/history/1958-5.jpg'),
          lazy: require('~/assets/history/1958-5-min.jpg?inline')
        }
      ]
    },
    {
    ...
    },
    {
      date: '25. März 1956',
      text:
        'Der SVE zitterte um den Klassenerhalt, sicherte sich diesen mit einem 10:1-Sieg über Glatten. Gefeiert wurde das Ereignis in der „Sonne“, „<i>jeder Spieler erhielt 1 Vesper und 1 Flasche Bier</i>“'
    },
    {
      date: '19. Februar 1956',
      text:
        '„<i>Das angesetzte Spiel Eutingen-Altensteig fiel wegen der Kälte aus</i>“. Der ganze Monat Februar war sehr kalt. Bis zu 27 Grad Kälte!'
    },
    {
      date: '12. Januar 1956',
      text:
    ...
    },
    {
      ...
      text:
        'Besser kann das Auf und Ab im Fußball gar nicht beschrieben werden, als im folgenden Spielbericht über die mit 3:1 gewonnene Begegnung gegen Wittershausen, den wir wörtlich zitieren: „<i>Aus Ärger über das letzte Spiel wohnte ich diesem Spiel nicht bei und der Folge: Die Mannschaft war nicht wieder zu erkennen. Es klappte alles wie am Schnürchen. Hervorgehoben werden muss unser Torwart Engelbert Mayer und der Linksaußen Wilhelm Marquardt. Erst in der letzten Minute schoss Wittershausen den Ehrentreffer.</i>“'
    },
    {
      date: '16. Oktober 1949',
      text:
        'Nach einer Reihe von Erfolgsmeldungen im Protokoll musste der SVE-Chronist auch solche Einträge wie über das 4. Verbandsspiel gegen Sigmarswangen machen: „<i>Über das Spiel möchte ich wenig berichten, denn es war so deprimierend, dass mir die Worte fehlen. Ergebnis 7:1</i>“'
    },
    {
      date: '10. Oktober 1949',
      text:
        '„<i>Anlässlich eines Fass Freibiers fand sich der Ausschuss und die 1. und 2. Mannschaft im Dreikönig zusammen.</i>“ In dieser „Sitzung“ wurde die Aufstellung einer Jugendmannschaft beschlossen. Zum Jugendwart wurde Hans Kramer bestellt, ein Mann, der sich in vielen Funktionen zeitlebens dem SVE verschrieben hat.'
    },
    {
    ...
    },
    {
      date: '20. März 1949',
      text:
        'Waren in der Vergangenheit insbesondere Torwartfehler ausdrücklich vermerkt, steht im Spielbericht über die Begegnung mit Bierlingen: „<i>Hervorgehoben werden muss unser Torwart Engelbert Mayer, der wunderbare Paraden zeigte!</i>“'
    },
    {
      date: '19. März 1949',
      text:
    ...
    },
    {
      ...
      text:
        'Schon eine Woche später fuhren die Eutinger zum Sommersportfest nach Wittershausen. „<i>Um halb 9 Uhr wartete eine stattliche Anzahl Sportbegeisterter beim Café Odermatt auf den von Vollmaringen kommenden Omnibus. Mit Gesang und Harmonikaspiel ging’s dann ab ...</i>“ notierte der Chronist die Fußballfahrt.'
    },
    {
      date: '29. August 1948',
      text:
    ...
    },
    {
      date: '1923',
      text:
        'Als Schüler machte Heinrich Kreidler das erste Jugendspiel in Untertalheim. Er erinnerte sich besonders gut daran, „<i>Weil wir nach dem Spiel fluchtartig Richtung Withau rennen mussten.</i>“'
    },
    {
      date: '1921',
      text:
