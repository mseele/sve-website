          ...
          <v-row align="center" class="pt-5 px-3">
            <v-sheet class="transparent black--text" max-width="500">
              ...
              <v-row class="mx-0 mt-4">
                ...
                <v-btn to="#partner" rounded depressed class="mt-2">
                  Unsere Partner
                </v-btn>
              </v-row>
            </v-sheet>
        ...
        <v-container>
          <v-row>
            ...
            <v-col cols="12" class="subtitle-1">
              Unsere Sponsoren und Partner ermöglichen durch ihre finanzielle
              und materielle Unterstützung das sportliche und kulturelle Angebot
              des SV Eutingen. Durch solche Kooperationen ist es möglich, ein
              ehrenamtlich breites Sportangebot auf die Beine zu stellen.
              Deshalb fühlen wir uns unseren Sponsoren gegenüber verpflichtet
              und nehmen deren Dienstleistungen und Produkte in Anspruch. Wenn
              ein besonderes Firmenevent, wie bspw. ein Jubiläum ins Haus steht,
              packen wir auch gerne tatkräftig mit an.<br />
              Die Möglichkeiten einer Sponsoringpartnerschaft sind vielfältig:
              Sponsoren können bspw. direkt in die Aus- und Weiterbildung
              unserer Jugendtrainer investieren oder für ein bestimmtes Team auf
              deren Trikots oder sonstigem Equipment Werbung machen. Hast auch
              Du Interesse an einer Partnerschaft? Dann wende Dich bitte über
              das
              <g-link
                :to="{
                  path: '/kontakt',
              ...
              >
              an unseren Vorsitzenden Sebastian Lazar, der für Gespräche gerne
              zur Verfügung steht.
            </v-col>
          </v-row>
        </v-container>
      ...
      <section id="bande" class="section_alt">
        <v-container>
          <v-row>
            ...
            <v-col cols="12" class="subtitle-1">
              Außerdem bieten wir mit unserem Partner der Eutinger Sportplatz-
              und Vereinswerbung GbR seit über 20 Jahren Bandenwerbung auf
              unserer sehr belebten Sportanlage. Die Abwicklung läuft
              unkompliziert. Wir kümmern uns über Anschaffung und Pflege der
              Bandenwerbung.
              <br />
        ...
        <v-container>
          <v-row class="pb-2">
            ...
            <v-col cols="12" class="subtitle-1">
              ...
              ihre materielle und finanzielle Unterstützung ermöglichen sie
              unser ehrenamtliches Angebot und machen auf ihre Produkte und
