    ...
    <page-section title="Termine">
      ...
      >
        <div class="tw-relative tw-h-full tw-overflow-hidden tw-wrap">
          <div
            class="tw-absolute tw-h-full tw-border tw-border-gray-700 tw-border-opacity-25 tw-border-solid tw-left-1/2"
          />
          <div
          ...
          >
            ...
            <div
              class="tw-z-10 tw-flex tw-items-center tw-self-center tw-flex-none tw-order-1 tw-w-6 tw-h-6 tw-bg-red-800 tw-border-white tw-border-solid tw-rounded-full tw-shadow tw-border-3"
            >
              <div
