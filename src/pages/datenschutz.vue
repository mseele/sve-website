      ...
      <v-container>
        <v-row>
          ...
          <v-col cols="12">
            ...
            <p>
              <strong>Vertretungsberechtigte Personen</strong>: Sebastian Lazar
              (1. Vorstand)
            </p>
          ...
          <v-col cols="12">
            ...
            <p>
              ...
              sogenannte Standardschutzklauseln der EU-Kommission, des
          ...
          <v-col cols="12">
            ...
            <ul>
              ...
              <li>
                <strong
                  >Third-Party-Cookies (auch: Drittanbieter-Cookies)</strong
          ...
          <v-col cols="12">
            <p>
              ...
              Mitgliedschafts- oder sonstigem geschäftlichen Verhältnis stehen
              und unsere Aufgaben wahrnehmen sowie Empfänger von Leistungen und
              Zuwendungen sind. Im Übrigen verarbeiten wir die Daten Betroffener
              auf Grundlage unserer berechtigten Interessen, z.B. wenn es sich
            ...
            <p>
              ...
              und die Erforderlichkeit ihrer Verarbeitung, bestimmen sich nach
              dem zugrundeliegenden Mitgliedschafts- oder Vertragsverhältnis,
              aus dem sich auch die Erforderlichkeit etwaiger Datenangaben
              ergeben (im Übrigen weisen wir auf erforderliche Daten hin).
            </p>
            <p>
            ...
            <ul class="m-elements">
              ...
              <li>
                ...
                Leistungen und Service, Kontaktanfragen und Kommunikation,
          ...
          <v-col cols="12">
            <p>
              ...
              Telefon oder via soziale Medien) werden die Angaben der
          ...
          <v-col cols="12">
            ...
            <p>
              <strong>Inhalte</strong>: Informationen zu uns, unseren
          ...
          <v-col cols="12">
            <p>
              Wir unterhalten Onlinepräsenzen innerhalb sozialer Netzwerke, um
            ...
            <p>
              ...
              Hinblick auf US-Anbieter, die unter dem Privacy-Shield
              zertifiziert sind oder vergleichbare Garantien eines sicheren
              Datenschutzniveaus bieten, weisen wir darauf hin, dass sie sich
          ...
          <v-col cols="12">
            <p>
              ...
              die sich insbesondere aus Art. 15 bis 18 und 21 DSGVO ergeben:
            </p>
            <ul>
              <li>
                <strong
          ...
          <v-col cols="12">
            ...
            <ul class="glossary">
              <li>
                ...
                Webseiten, auf denen die Marketingmaßnahmen erfolgen,
              ...
              <li>
                ...
                Aufsuchen von bestimmten Webseiten und Verweilen auf diesen,
                Kaufverhaltens oder Interaktion mit anderen Nutzern), die in
                einem sogenannten Profil gespeichert werden. Zu diesen Zwecken
                werden im Regelfall Cookies eingesetzt.
              </li>
              <li>
                <strong>Konversionsmessung:</strong> Die Konversionsmessung ist
