<template>
  <Layout>
    <page-section title="Datenschutzerklärung">
      ...
      <div class="tw-pb-8 tw-space-y-2">
        ...
        <div>
          <strong>Vertretungsberechtigte Personen</strong>: Sebastian Lazar (1.
          Vorstand)
        </div>
      ...
      <div class="tw-pb-8 tw-space-y-2">
        ...
        <div>
          ...
          gehören, oder auf Grundlage besonderer Garantien, wie z.B.
      ...
      <div class="tw-pb-8 tw-space-y-2">
        ...
        <div>
          ...
          unseres Onlineangebotes erforderlich sind. Deren Einsatz erfolgt auf
      ...
      <div class="tw-pb-8 tw-space-y-2">
        ...
        <ul class="glossary">
          <li>
            ...
            denen die Marketingmaßnahmen erfolgen, gespeichert und dann erneut
            auf der Zielwebseite abgerufen. Beispielsweise können wir so
          ...
          <li>
            ...
            mehr der eindeutigen Identifizierung einer Person dienen kann. Daher
            ist das IP-Masking ein Mittel zur Pseudonymisierung von
            Verarbeitungsverfahren, insbesondere im Onlinemarketing
          </li>
          <li>
            <strong
              >Interessenbasiertes und verhaltensbezogenes Marketing:</strong
            >
          ...
          <li>
            <strong>Konversionsmessung:</strong> Die Konversionsmessung ist ein
            ...
            Zielwebseite abgerufen. Beispielsweise können wir so nachvollziehen,
            ob die von uns auf anderen Webseiten geschalteten Anzeigen
            erfolgreich waren.
          </li>
          <li>
          ...
          <li>
            ...
            Person beziehen (je nach Art des Profilings gehören dazu
