<template>
  ...
  >
    <div class="tw-flex tw-flex-col sm:tw-flex-row xl:tw-justify-between">
      ...
      >
        <button
          class="tw-flex-grow tw-px-4 tw-py-2 tw-text-sm tw-font-bold tw-tracking-widest tw-text-red-100 tw-uppercase tw-bg-gray-900 tw-rounded-full tw-shadow-sm hover:tw-bg-black hover:tw-text-gray-300 xl:tw-text-base tw-font focus-visible:tw-outline-none focus-visible:tw-ring"
          @click="accept"
        >
          Akzeptieren
        </button>
        <button
          class="tw-flex-grow tw-px-4 tw-py-2 tw-text-sm tw-font-bold tw-tracking-widest tw-text-red-100 tw-uppercase hover:tw-text-red-200 xl:tw-text-base focus-visible:tw-outline-none focus-visible:tw-ring"
          @click="deny"
        >
          Ablehnen
        </button>
