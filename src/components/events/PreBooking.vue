<template>
  <div class="flex h-full items-center justify-center">
    <div
      v-if="success == undefined && error == undefined"
      class="my-10 flex flex-col items-center 2xl:my-20"
    >
      <svg
        class="h-10 w-10 animate-spin self-center justify-self-center text-red-800 2xl:h-16 2xl:w-16"
      ...
      <div class="pt-4 text-stone-600 2xl:pt-8 2xl:text-2xl">
    ...
    <div v-else class="flex w-full flex-col items-center">
      ...
      <div
        class="pb-6 text-center text-lg text-stone-700 xl:pb-8 xl:text-xl 2xl:pb-10 2xl:text-3xl"
      >
        {{ success || error }}
      </div>
      <PrimaryLink
